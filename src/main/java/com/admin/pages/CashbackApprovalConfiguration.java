...
public class CashbackApprovalConfiguration extends WrapperMethods {
	
	public CashbackApprovalConfiguration(WebDriver driver, ExtentTest logger) {
	...
	public void clickCashbackApprovalConfigurationSubMenu(WebDriver driver) {

		reportStep(logger, "About to click submenu BonusApprovalConfiguration in admin homepage", "INFO");
		
		//Click cashback submenu button
		if(jsClickUsingID(driver, "SubMenu_CashbackApprovalConfiguration")) {
