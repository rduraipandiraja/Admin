...
public class StoreVoucherCreationSuiteTwo extends WrapperMethods {

	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store one - Creation and Loading the Corresponding Dynamic Values into Json File							   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_One_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			objLogin = new Login(driver, logger); objDashboard = new Dashboard(driver, logger);
			...
			String arrayNewStoreDetails_One[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041", "72", "ACTIVATE REWARDS", "90", "orderID", "Within 4 Days of Shipment", "check", "check", "check", "check");
			...
			String[] array_New_Rewards_Store_One_Details = new String[] {arrayNewStoreDetails_One[0], arrayNewStoreDetails_One[1], arrayNewStoreDetails_One[2], arrayNewStoreDetails_One[3], arrayNewStore_Nor_PCBDetails_One[6].toString(),
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_One("RW", array_New_Rewards_Store_One_Details,"RW_Store_One");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_One");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store two - Creation and Loading the Corresponding Dynamic Values into Json File							   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Two_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Two[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041", "72", "ACTIVATE REWARDS", "90", "orderID", "Within 4 Days of Shipment", "check", "check", "check", "check");
			...
			String[] array_New_Rewards_Store_Two_Details = new String[] {arrayNewStoreDetails_Two[0], arrayNewStoreDetails_Two[1], arrayNewStoreDetails_Two[2], arrayNewStoreDetails_Two[3], arrayNewStore_Cal_PCBDetails_Two[11].toString(),
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Two("RW", array_New_Rewards_Store_Two_Details,"RW_Store_Two");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Two");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store three - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Three_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Three[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041", "72", "ACTIVATE REWARDS", "90", "orderID", "Within 4 Days of Shipment", "check", "check", "check", "check");
			...
			String[] array_New_Rewards_Store_Three_Details = new String[] {arrayNewStoreDetails_Three[0], arrayNewVoucher_Without_Code_Three[1], arrayNewStore_Others_Details_Three[0].toString(), 
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Three("RW", array_New_Rewards_Store_Three_Details,"RW_Store_Three");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Three");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	@Test	
	public void rewards_Store_Four_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Four("RW", array_New_Rewards_Store_Four_Details,"RW_Store_Four");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Four");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	@Test
	public void rewards_Store_Five_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Five("RW", array_New_Rewards_Store_Five_Details,"RW_Store_Five");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Five");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store six - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Six_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Six[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041");
			...
			String[] array_New_Rewards_Store_Six_Details = new String[] {arrayNewStoreDetails_Six[0], arrayNewStore_Cal_PCBDetails_Six[6].toString(),  
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Six("RW", array_New_Rewards_Store_Six_Details,"RW_Store_Six");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Six");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store seven - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Seven_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Seven[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041");
			...
			String[] array_New_Rewards_Store_Seven_Details = new String[] {arrayNewStoreDetails_Seven[0], arrayNewStore_Cal_PCBDetails_Seven[6].toString(),  
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Seven("RW", array_New_Rewards_Store_Seven_Details,"RW_Store_Seven");

			basedOnBooleanValuePrintsReport(value);
			reportStep(logger,"Successfully Created the Store and Loaded the Respective Store Creation Dynamic Value into the Json File", "INFO");

		}catch (Exception e) {

			e.printStackTrace();

			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Seven");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store eight - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Eight_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Eight[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041", "72", "ACTIVATE REWARDS", "90", "orderID", "Within 4 Days of Shipment", "check", "check", "check", "check");
			...
			String strTextToEnter_Keywords_Details = objAddStore.enterKeywordsDetails(driver, arrayNewStoreDetails_Eight[0]);

			String newStore_Input_Meta_Tags_Details = objAddStore.enterMetaTags(driver, arrayNewStoreDetails_Eight[0]);

			String newStore_Input_Product_Meta_Tags_Details = objAddStore.enterProductMetaTags(driver, arrayNewStoreDetails_Eight[0]);

			String newStore_Input_Social_Media_Message_Details = objAddStore.enterSocialMediaMessageDetails(driver, "This is "+arrayNewStoreDetails_Eight[0]+" social message");

			Object arrayNewStore_Nor_PCBDetails_Eight[] = objAddStore.enterNormalPrimaryCashbackDetails(driver, "Currency", "INR", 1500, 75, "This Is Test User Entering normal Primary cashback");

			Object arrayNewStore_Nor_SCBDetails_Eight[] = objAddStore.enterNormalSecondaryCashbackDetails(driver, 0, "Currency", 1250, "This Is Test User Entering Normal Secondary cashback", "All", 0);

			Object arrayNewStore_Others_Details_Eight[] = objAddStore.enterOthers(driver, "Terms and conditions");

			String arrayNewStore_StoreContent_Details_One = objAddStore.StoreContent_Creation(driver, arrayNewStoreDetails_Eight[0]);
			...
			String strStoreType = objAddStore.getStoreType(driver, arrayNewStoreDetails_Eight[0].trim());
			...
			String arrayNewVoucher_Without_Code_Eight[] = objVouchers.enterVoucherWithoutCodeDetails_APITesting(driver, arrayNewStoreDetails_Eight, "Increased Rate", "All", strStoreID);

			String arrayNewVoucher_With_Code_Eight[] = objVouchers.enterVoucherWithCodeDetails_APITesting(driver, arrayNewStoreDetails_Eight, "Increased Rate", "COUPON CODE", "All", strStoreID);
			...
			objVouchers.enterStoreName(driver, arrayNewStoreDetails_Eight[0]);
			...
			String strVoucherType_One = objVouchers.getVoucherType(driver, arrayNewVoucher_Without_Code_Eight[1].trim(), 1);

			String strVoucherType_Two = objVouchers.getVoucherType(driver, arrayNewVoucher_With_Code_Eight[1].trim(), 1);
			...
			objAffillateNetwork.clickAffiliateNetworkEditIcon(driver, arrayNewStoreDetails_Eight[3].trim());
			...
			String[] array_New_Rewards_Store_Eight_Details = new String[] {arrayNewStoreDetails_Eight[0], arrayNewStoreDetails_Eight[1], arrayNewStoreDetails_Eight[2], arrayNewStoreDetails_Eight[3], arrayNewStoreDetails_Eight[4],
					arrayNewStoreDetails_Eight[5], arrayNewStoreDetails_Eight[7], arrayNewStoreDetails_Eight[10], arrayNewStoreDetails_Eight[11], arrayNewStore_Nor_PCBDetails_Eight[0].toString(), 
					arrayNewStore_Nor_PCBDetails_Eight[4].toString(), arrayNewStore_Nor_PCBDetails_Eight[5].toString(), arrayNewStore_Nor_SCBDetails_Eight[1].toString(), arrayNewStore_Nor_SCBDetails_Eight[2].toString(), 
					arrayNewStore_Nor_SCBDetails_Eight[3].toString(), arrayNewVoucher_Without_Code_Eight[1], arrayNewVoucher_Without_Code_Eight[2], arrayNewVoucher_Without_Code_Eight[5], arrayNewVoucher_Without_Code_Eight[6], 
					...
					arrayNewVoucher_With_Code_Eight[7], arrayNewVoucher_With_Code_Eight[8], strStoreID, strVoucherID_One, strVoucherID_Two, strVoucherCount, arrayNewStoreDetails_Eight[12], array_CategoryValues , 
					...
					arrayNewVoucher_Without_Code_Eight[10], arrayNewVoucher_With_Code_Eight[11], arrayNewVoucher_With_Code_Eight[12], arrayNewVoucher_With_Code_Eight[11], str_Affiliate_Network_Id, strStoreType, 
					strVoucherType_One, strVoucherType_Two, arrayNewStore_StoreContent_Details_One, strTextToEnter_Keywords_Details, newStore_Input_Meta_Tags_Details, newStore_Input_Product_Meta_Tags_Details, 
					newStore_Input_Social_Media_Message_Details, (arrayNewStore_Others_Details_Eight[0]).toString(), arrayNewVoucher_With_Code_Eight[3], strSecondaryCashbackId, arrayNewVoucher_With_Code_Eight[3], 
					...
					arrayNewStoreDetails_Eight[23], arrayNewStoreDetails_Eight[24], arrayNewStore_Nor_PCBDetails_Eight[6].toString(), arrayNewStore_Nor_PCBDetails_Eight[7].toString(), strExecution_BooleanStatus};		

			/**************************************************************** LOADING VALUE TO JSON ****************************************************************************/

			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Eight("RW", array_New_Rewards_Store_Eight_Details,"RW_Store_Eight");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Eight");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store nine - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test
	public void rewards_Store_Nine_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Nine[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041", "72", "ACTIVATE REWARDS", "90", "orderID", "Within 4 Days of Shipment", "check", "check", "check", "check");
			...
			String arrayNewVoucher_With_Code_Nine[] = objVouchers.enterVoucherWithCodeDetails_APITesting(driver, arrayNewStoreDetails_Nine, "Increased Rate", "COUPON CODE", "All", strStoreID);
			...
			String[] array_New_Rewards_Store_Nine_Details = new String[] {arrayNewStoreDetails_Nine[0], arrayNewStoreDetails_Nine[1], arrayNewStoreDetails_Nine[2], arrayNewStoreDetails_Nine[3], arrayNewStore_Cal_PCBDetails_Nine[11].toString(),
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Nine("RW", array_New_Rewards_Store_Nine_Details,"RW_Store_Nine");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Nine");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store ten - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test
	public void rewards_Store_Ten_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Ten[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041", "72", "ACTIVATE REWARDS", "90", "orderID", "Within 4 Days of Shipment", "check", "check", "check", "check");
			...
			String[] array_New_Rewards_Store_Ten_Details = new String[] {arrayNewStoreDetails_Ten[0], arrayNewVoucher_Without_Code_Ten[1], arrayNewStore_Others_Details_Ten[0].toString(), 
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Ten("RW", array_New_Rewards_Store_Ten_Details,"RW_Store_Ten");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Ten");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store eleven - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Eleven_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Eleven[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "All", "999041");
			...
			String[] array_New_Rewards_Store_Eleven_Details = new String[] {arrayNewStoreDetails_Eleven[0], arrayNewStoreDetails_Eleven[1], arrayNewStoreDetails_Eleven[4], 
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Eleven("RW", array_New_Rewards_Store_Eleven_Details,"RW_Store_Eleven");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Eleven");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store twelve - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Twelve_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Twelve[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "Desktop", "999041");
			...
			String[] array_New_Rewards_Store_Twelve_Details = new String[] {arrayNewStoreDetails_Twelve[0], arrayNewStoreDetails_Twelve[1], arrayNewStoreDetails_Twelve[2], arrayNewStoreDetails_Twelve[3], arrayNewStoreDetails_Twelve[4],
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Twelve("RW", array_New_Rewards_Store_Twelve_Details,"RW_Store_Twelve");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Twelve");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store thirteen - Creation and Loading the Corresponding Dynamic Values into Json File						   			    **/
	/*************************************************************************************************************************************************************************************/

	@Test	
	public void rewards_Store_Thirteen_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Thirteen[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "Mobile", "999041");
			...
			String[] array_New_Rewards_Store_Thirteen_Details = new String[] {arrayNewStoreDetails_Thirteen[0], arrayNewStoreDetails_Thirteen[1], arrayNewStoreDetails_Thirteen[2], arrayNewStoreDetails_Thirteen[3], arrayNewStoreDetails_Thirteen[4],
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Thirteen("RW", array_New_Rewards_Store_Thirteen_Details,"RW_Store_Thirteen");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Thirteen");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										 Rewards Store fourteen - Creation and Loading the Corresponding Dynamic Values into Json File						   			    **/
	/*************************************************************************************************************************************************************************************/

	@Test
	public void rewards_Store_Fourteen_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Fourteen[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "Tablet", "999041");
			...
			String[] array_New_Rewards_Store_Fourteen_Details = new String[] {arrayNewStoreDetails_Fourteen[0], arrayNewStoreDetails_Fourteen[1], arrayNewStoreDetails_Fourteen[2], arrayNewStoreDetails_Fourteen[3], arrayNewStoreDetails_Fourteen[4],
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Fourteen("RW", array_New_Rewards_Store_Fourteen_Details,"RW_Store_Fourteen");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Fourteen");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	@Test	
	public void rewards_Store_Fifteen_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			String arrayNewStoreDetails_Fifteen[] = objAddStore.enterRewardStoreDetails(driver, "Active", "Adda52", "", "https://www.myntra.com/", "https://www.myntra.com/", "", "Terms and conditions", "App", "999041");
			...
			String[] array_New_Rewards_Store_Fifteen_Details = new String[] {arrayNewStoreDetails_Fifteen[0], arrayNewStoreDetails_Fifteen[1], arrayNewStoreDetails_Fifteen[2], arrayNewStoreDetails_Fifteen[3], arrayNewStoreDetails_Fifteen[4],
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Fifteen("RW", array_New_Rewards_Store_Fifteen_Details,"RW_Store_Fifteen");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("RW", "RW_Store_Fifteen");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
	...
	/*************************************************************************************************************************************************************************************/
	/** 										Mob Cash back Store five - Creation and Loading the Corresponding Dynamic Values into Json File						   			     	**/
	/*************************************************************************************************************************************************************************************/

	@Test
	public void mob_Cashback_Store_Five_Creation(Method method) throws InterruptedException, AWTException{
		...
		try {
			...
			Boolean value = objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Store_Five("MOB_CB", array_New_CashBack_Store_Five_Details,"MOB_CB_Store_Five");
			...
			objStoreCCL.loading_Dynamic_TestData_Into_JsonFile_Failed("MOB_CB", "MOB_CB_Store_Five");
			reportStep(logger, "Error message: "+e.getMessage()+"", "FAIL");
			reportStep(logger, "Store Creation has not been done properly", "FAIL");
